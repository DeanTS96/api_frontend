    ...
    return (
        <div className="padding-20">
            ...
            <p className="size-15em page-title">Create Account</p>
                <form className="border-2px rounded padding-20 content-item bg-lightblue width-mx-600 account">
                    ...
                    <button className="dis-blk button-submit rounded size-10em btn" type="submit" onSubmit={(e)=>{handleSubmit(e)}}>Submit</button>
                </form>
        </div>
    )
}
